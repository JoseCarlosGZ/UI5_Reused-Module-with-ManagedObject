		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Reutilizar código con clase ManagedObject",
									"targetURL": "#josecarlosgzManagedObject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"josecarlosgzManagedObject-display": {
								"semanticObject": "josecarlosgzManagedObject",
								"action": "display",
								"description": "Reutilizar código con clase ManagedObject",
								"title": "Reutilizar código con clase ManagedObject",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=josecarlosgz.ManagedObject",
									"url": sap.ui.require.toUrl("josecarlosgz/ManagedObject")
								}
							}
						}
					}
